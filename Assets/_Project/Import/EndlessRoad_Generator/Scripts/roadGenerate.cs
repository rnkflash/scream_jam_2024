...
{
    private float
        newTileToPlayerDist; //absract variable to make a point in 3d world to create new road segment from this coordinates
...
// Use this for initialization
    void Start()
    {
        ...
        roadHardess =
            Mathf.Clamp(roadHardess, 0,
                100); //roadHardess MUST be between 0 and 100;(maybe someone wiil make it -5 or 4737 by mistake)

        Transform
            forAutoPilot = lastRoadTile.transform.Find("roadEndCoords"); //for AI navigation to know where to drive to
    ...
    private void makeRoadSegment(GameObject loadingRoadPrefab)
    {
        ...
        GameObject lastRoadTile =
            Instantiate(loadingRoadPrefab, position, Quaternion.Euler(lastRoadTileEndRotation), parentForTiles) as GameObject;
